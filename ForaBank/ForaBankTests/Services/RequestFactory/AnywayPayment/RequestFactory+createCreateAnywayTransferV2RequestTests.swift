//
//  RequestFactory+createCreateAnywayTransferV2RequestTests.swift
//  VortexTests
//
...
final class RequestFactory_createCreateAnywayTransferV2RequestTests: XCTestCase {
    ...
    func test_createRequest_shouldSetRequestURL() throws {
        ...
        XCTAssertNoDiff(
            ...
            "https://pl.innovation.ru/dbo/api/v3/rest/transfer/v2/createAnywayTransfer"
        )
    }
    ...
    private func createRequest(
        ...
        try ForaBank.RequestFactory.createCreateAnywayTransferV2Request(payload)
    }
