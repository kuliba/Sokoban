...
class ServerCommandsTransferTests: XCTestCase {
    ...
    func testCreateAnywayTransfer_Response_Decoding() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateAnywayTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: 100, creditAmount: 100, currencyAmount: "100.00", currencyPayee: "RUB", currencyPayer: "RUB", currencyRate: 86.7, debitAmount: 100, fee: 100, needMake: true, needOTP: true, payeeName: "Иван Иванович И.", documentStatus: .complete, paymentOperationDetailId: 1, additionalList: [.init(fieldName: "a3_PERSONAL_ACCOUNT_5_5", fieldTitle: "Лицевой счет у Получателя", fieldValue: "1234567890", svgImage: .init(description: "string"))], finalStep: false, infoMessage: "string", needSum: false, parameterListForNextStep: [.init(content: "account", dataType: "%String", id: "a3_NUMBER_1_2", isPrint: false, isRequired: true, mask: "+7(___)-___-__-__", maxLength: 10, minLength: 0, order: 2, rawLength: 0, readOnly: false, regExp: "^\\d{10}$", subTitle: "Пример: 9051111111", svgImage: .init(description: "string"), title: "Номер телефона +7", type: "Input", viewType: .input)]))
    ...
    func testCreateAnywayTransfer_Response_Decoding_Min() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateAnywayTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: nil, creditAmount: nil, currencyAmount: nil, currencyPayee: nil, currencyPayer: nil, currencyRate: nil, debitAmount: nil, fee: nil, needMake: nil, needOTP: nil, payeeName: nil, documentStatus: nil, paymentOperationDetailId: 1, additionalList: [.init(fieldName: "a3_PERSONAL_ACCOUNT_5_5", fieldTitle: "Лицевой счет у Получателя", fieldValue: "1234567890", svgImage: nil)], finalStep: false, infoMessage: nil, needSum: false, parameterListForNextStep: [.init(content: nil, dataType: "%String", id: "a3_NUMBER_1_2", isPrint: nil, isRequired: true, mask: "+7(___)-___-__-__", maxLength: nil, minLength: nil, order: nil, rawLength: 0, readOnly: false, regExp: "^\\d{10}$", subTitle: nil, svgImage: nil, title: "Номер телефона +7", type: "Input", viewType: .input)]))
    ...
    func testCreateContactAddresslessTransfer_Response_Decoding() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateContactAddresslessTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: 100, creditAmount: 100, currencyAmount: "100.00", currencyPayee: "RUB", currencyPayer: "RUB", currencyRate: 86.7, debitAmount: 100, fee: 100, needMake: true, needOTP: true, payeeName: "Иван Иванович И.", documentStatus: .complete, paymentOperationDetailId: 1, additionalList: [.init(fieldName: "a3_PERSONAL_ACCOUNT_5_5", fieldTitle: "Лицевой счет у Получателя", fieldValue: "1234567890", svgImage: .init(description: "string"))], finalStep: false, infoMessage: "string", needSum: false, parameterListForNextStep: [.init(content: "account", dataType: "%String", id: "a3_NUMBER_1_2", isPrint: false, isRequired: true, mask: "+7(___)-___-__-__", maxLength: 10, minLength: 0, order: 2, rawLength: 0, readOnly: false, regExp: "^\\d{10}$", subTitle: "Пример: 9051111111", svgImage: .init(description: "string"), title: "Номер телефона +7", type: "Input", viewType: .input)]))
    ...
    func testCreateDirectTransfer_Response_Decoding() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateDirectTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: 100, creditAmount: 100, currencyAmount: "100.00", currencyPayee: "RUB", currencyPayer: "RUB", currencyRate: 86.7, debitAmount: 100, fee: 100, needMake: true, needOTP: true, payeeName: "Иван Иванович И.", documentStatus: .complete, paymentOperationDetailId: 1, additionalList: [.init(fieldName: "a3_PERSONAL_ACCOUNT_5_5", fieldTitle: "Лицевой счет у Получателя", fieldValue: "1234567890", svgImage: .init(description: "string"))], finalStep: false, infoMessage: "string", needSum: false, parameterListForNextStep: [.init(content: "account", dataType: "%String", id: "a3_NUMBER_1_2", isPrint: false, isRequired: true, mask: "+7(___)-___-__-__", maxLength: 10, minLength: 0, order: 2, rawLength: 0, readOnly: false, regExp: "^\\d{10}$", subTitle: "Пример: 9051111111", svgImage: .init(description: "string"), title: "Номер телефона +7", type: "Input", viewType: .input)]))
    ...
    func testCreateMe2MePullDebitTransfer_Response_Decoding() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateMe2MePullDebitTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: 100, creditAmount: 100, currencyAmount: "100.00", currencyPayee: "RUB", currencyPayer: "RUB", currencyRate: 86.7, debitAmount: 100, fee: 100, needMake: true, needOTP: true, payeeName: "Иван Иванович И.", documentStatus: .complete, paymentOperationDetailId: 1, additionalList: [.init(fieldName: "a3_PERSONAL_ACCOUNT_5_5", fieldTitle: "Лицевой счет у Получателя", fieldValue: "1234567890", svgImage: .init(description: "string"))], finalStep: false, infoMessage: "string", needSum: false, parameterListForNextStep: [.init(content: "account", dataType: "%String", id: "a3_NUMBER_1_2", isPrint: false, isRequired: true, mask: "+7(___)-___-__-__", maxLength: 10, minLength: 0, order: 2, rawLength: 0, readOnly: false, regExp: "^\\d{10}$", subTitle: "Пример: 9051111111", svgImage: .init(description: "string"), title: "Номер телефона +7", type: "Input", viewType: .input)]))
    ...
    func testCreateTransfer_Response_Decoding() throws {
        ...
        let json = try Data(contentsOf: url)
        let expected = ServerCommands.TransferController.CreateTransfer.Response(statusCode: .ok, errorMessage: "string", data: .init(amount: 100, creditAmount: 100, currencyAmount: "100.00", currencyPayee: "RUB", currencyPayer: "RUB", currencyRate: 86.7, debitAmount: 100, fee: 00, needMake: true, needOTP: true, payeeName: "Иван Иванович И.", documentStatus: .complete, paymentOperationDetailId: 1))
