...
class ServerCommandsSuggestTests: XCTestCase {
    ...
    func testSuggestCompany_Server_Response() throws {
        
        // given
        let url = bundle.url(forResource: "SuggestCompanyResponseGeneric", withExtension: "json")!
        let json = try Data(contentsOf: url)
