...
final class Services_getLandingServiceTests: XCTestCase {
    ...
    func test_perform_abroadTransfer_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=abroadTransfer"
    ...
    func test_perform_abroadOrderCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let abroadType: AbroadType = .orderCard
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=abroadOrderCard"
    ...
    func test_perform_mainCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_MAIN_CARD"
    ...
    func test_perform_regularCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_REGULAR_CARD"
    ...
    func test_perform_additionalSelfCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_ADDITIONAL_SELF_CARD"
    ...
    func test_perform_additionalSelfAccOwnCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_ADDITIONAL_SELF_ACC_OWN_CARD"
    ...
    func test_perform_additionalOtherCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_ADDITIONAL_OTHER_CARD"
    ...
    func test_perform_additionalCorporateCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_ADDITIONAL_CORPORATE_CARD"
    ...
    func test_perform_corporateCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_CORPORATE_CARD"
    ...
    func test_perform_individualBusinessmanCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_INDIVIDUAL_BUSINESSMAN_CARD"
    ...
    func test_perform_individualBusinessmanMainCard_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=CONTROL_INDIVIDUAL_BUSINESSMAN_MAIN_CARD"
    ...
    func test_perform_marketShowcase_shouldCallHTTPClientWithCorrectURLInRequest() {
        ...
        let (sut, spy) = makeSUT()
        let correctURLString = "https://pl.\(Config.domen)/dbo/api/v3/dict/v2/getJsonAbroad?serial=1&type=market_showcase"
