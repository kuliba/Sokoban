...
final class RequestFactory_createGetProductListByTypeRequestTests: XCTestCase {
    ...
    func test_createRequest_shouldSetRequestURL() throws {
        ...
        XCTAssertEqual(
            ...
            "https://pl.\(Config.domen)/dbo/api/v3/rest/v5/getProductListByType?productType=CARD"
        )
    }
    ...
    private func createRequest(
        ...
        try Vortex.RequestFactory.createGetProductListByTypeRequest(payload, timeout)
    }
}
