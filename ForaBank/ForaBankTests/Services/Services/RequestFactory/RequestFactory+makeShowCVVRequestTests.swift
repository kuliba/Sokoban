...
final class RequestFactory_makeShowCVVRequestTests: XCTestCase {
    ...
    func test_makeRequest_shouldSetRequestURL() throws {
        ...
        XCTAssertEqual(
            ...
            "https://dmz-api-gate-test.\(Config.domen)/processing/cardInfo/v1/showCVV"
        )
    }
    ...
    private func makeRequest(
        ...
        try RequestFactory.makeShowCVVRequest(
            sessionID: sessionID,
            data: data
        )
    }
