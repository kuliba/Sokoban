//
//  Services+getProductDynamicParamsListTests.swift
//  ForaBankTests
//
...
final class Services_getProductDynamicParamsListTests: XCTestCase {
    ...
    private func makeSUT(
        ...
        sut: Services.GetProductDynamicParamsListService,
        spy: HTTPClientSpy
    ) {
        let spy = HTTPClientSpy()
        
        let sut = Services.getProductDynamicParamsList (
            httpClient: spy
        )
    ...
    private typealias Payload =  CardStatementAPI.ProductDynamicParamsListPayload
    
    private func expect(
        _ sut: Services.GetProductDynamicParamsListService,
        toDeliver expectedResult: Services.GetProductDynamicParamsListResult,
        on action: () -> Void,
        file: StaticString = #file,
        line: UInt = #line
    ) throws {
