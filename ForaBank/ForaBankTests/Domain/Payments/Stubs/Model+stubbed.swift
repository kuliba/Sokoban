...
extension DaDataPhoneData {
    ...
    static let iVortex4285: Self = .iVortex(
        cityCode: 903,
    ...
    static let iVortex4286: Self = .iVortex(
        cityCode: 919,
...
extension ServerAgentStub.EssenceStub {
    ...
    static let preview: Self  = [
        .iVortex_4285_9rub:   .iVortex_4285_9rub,
        .iVortex_4285_10rub:  .iVortex_4285_10rub,
        .iVortex_4286:        .iVortex_4286,
        .iVortex_515A3_1rub:  .iVortex_515A3_1rub,
        .iVortex_515A3_10rub: .iVortex_515A3_10rub,
    ]
}

extension ServerAgentStub.Essence {
    
    static let iVortex_4285_9rub: Self    = .init("iVortex_4285",  "9039999999",  9.0)
    static let iVortex_4285_10rub: Self   = .init("iVortex_4285",  "9039999999", 10.0)
    static let iVortex_4286: Self         = .init("iVortex_4286",  "9191619658",  1.0)
    static let iVortex_515A3_1rub: Self   = .init("iVortex_515A3", "9999679969",  1.0)
    static let iVortex_515A3_10rub: Self  = .init("iVortex_515A3", "9999679969", 10.0)
...
extension ServerCommands.TransferController.CreateAnywayTransfer.Payload {
    ...
    static let iVortex_4285_9rub: Payload = try! decode(from: "createAnywayTransfer_iVortex_4285_9rub_request")
    
    static let iVortex_4285_10rub: Payload = try! decode(from: "createAnywayTransfer_iVortex_4285_10rub_request")
    
    static let iVortex_4286: Payload = try! decode(from: "createAnywayTransfer_iVortex_4286_request")
    
    static let iVortex_515A3_1rub: Payload = try! decode(from: "createAnywayTransfer_iVortex_515A3_1rub_request")
    
    static let iVortex_515A3_10rub: Payload = try! decode(from: "createAnywayTransfer_iVortex_515A3_10rub_request")
...
extension ServerCommands.TransferController.CreateAnywayTransfer.Response {
    ...
    static let iVortex_4285_9rub: Self = try! decode(from: "createAnywayTransfer_iVortex_4285_9rub_response")

    static let iVortex_4285_10rub: Self = try! decode(from: "createAnywayTransfer_iVortex_4285_10rub_response")

    static let iVortex_4286: Self = try! decode(from: "createAnywayTransfer_iVortex_4286_response")

    static let iVortex_515A3_1rub: Self = try! decode(from: "createAnywayTransfer_iVortex_515A3_1rub_response")

    static let iVortex_515A3_10rub: Self = try! decode(from: "createAnywayTransfer_iVortex_515A3_10rub_response")
