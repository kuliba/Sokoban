...
//  ForaBank
//
//  Created by Dmitriy Savushkin on 12.06.2022.
//
...
class OpenAccountItemViewModel: ObservableObject, Identifiable {
...
extension OpenAccountItemViewModel {
...
struct OpenAccountItemView<OpenAccountCardView: View>: View {
    
    @ObservedObject var viewModel: OpenAccountItemViewModel.ViewModel
    let openAccountCardView: () -> OpenAccountCardView
    let config: OpenAccountItemViewModel.Config
            ...
            VStack(alignment: .leading) {
                ...
                HStack(alignment: .top, spacing: 20) {
                    ...
                    VStack {
                        ...
                        ForEach(viewModel.options, content: optionView)
                    }
                }.padding(20)
    ...
    private func optionView(
        option: OpenAccountItemViewModel.OptionViewModel
    ) -> some View {
...
extension OpenAccountItemView {
    ...
    struct HeaderView: View {
        ...
        @ObservedObject var viewModel: OpenAccountItemViewModel.HeaderViewModel
        let config: OpenAccountItemViewModel.Config.Header
    ...
    struct OptionView: View {
        ...
        let viewModel: OpenAccountItemViewModel.OptionViewModel
        let config: OpenAccountItemViewModel.Config.Option
...
extension OpenAccountItemViewModel.ViewModel {
    
    static func emptyStub() -> OpenAccountItemViewModel.ViewModel {
    ...
    static func sampleStub() -> OpenAccountItemViewModel.ViewModel {
    ...
    static func configStub() -> OpenAccountItemViewModel.Config {
