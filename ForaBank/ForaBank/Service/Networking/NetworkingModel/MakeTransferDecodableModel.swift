//
//  MakeTransferDecodableModel.swift
//  ForaBank
//
...
//
//   let makeTransferDecodableModel = try MakeTransferDecodableModel(json)
...
extension MakeTransferDecodableModel {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(MakeTransferDecodableModel.self, from: data)
    }
