//
//  GetCardListDecodebleModel.swift
//  ForaBank
//
...
//
//   let getCardListDecodebleModel = try GetCardListDecodebleModel(json)

import Foundation

// MARK: - GetCardListDecodebleModel
...
extension GetCardListDecodebleModel {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(GetCardListDecodebleModel.self, from: data)
    }
...
// To parse the JSON, add this file to your project and do:
//
//   let original = try Original(json)
...
extension Original {
    init(data: Data) throws {
        self = try newJSONDecoder().decode(Original.self, from: data)
    }
