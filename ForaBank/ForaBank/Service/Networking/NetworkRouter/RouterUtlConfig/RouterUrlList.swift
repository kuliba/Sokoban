...
enum RouterUrlList: String {
    ...
    func returnUrl () -> URLValue {
        ...
        case .getDepositStatement:
            let result = URLConstruct.setUrl(.https, .qa, RouterBaseUrlList.getDepositStatement.rawValue)
        ...
        case .getDepositInfo:
            let result = URLConstruct.setUrl(.https, .qa, RouterBaseUrlList.getDepositInfo.rawValue)
        ...
        case .getDepositProductList:
            let result = URLConstruct.setUrl(.https, .qa, RouterBaseUrlList.getDepositProductList.rawValue)
            switch result {
            case .success(let url):
                return .success(url.absoluteURL)
            case .failure(let error):
        ...
        case .changeOutgoing:
            let result = URLConstruct.setUrl(.https, .qa, RouterBaseUrlList.changeOutgoing.rawValue)
            switch result {
            case .success(let url):
                return .success(url.absoluteURL)
            case .failure(let error):
        ...
        case .getPrintFormForDepositConditions:
            let result = URLConstruct.setUrl(.https, .qa, RouterBaseUrlList.getPrintFormForDepositConditions.rawValue)
            switch result {
            case .success(let url):
                return .success(url.absoluteURL)
            case .failure(let error):
