           ...
           content: .items(
               ...
               .init(type: .currency,
                ...
                .init(type: .currency,
                      ...
                      subtitle: "Драм",
                      action: {},
                      topDashboard: .init(kindImage: .down, valueText: "16,95", type: .buy, action: {}),
                      bottomDashboard: .init(kindImage: .up, valueText: "15,35", type: .sell, action: {})),
               .init(type: .currency,
                     mainImg: ("3", Image("Flag CHF")),
                     title: "CHF",
                     subtitle: "Франк",
                     action: {},
