...
extension Model {
 ...
 extension Model {
     ...
     func getHeaderIconForOperation(source: Payments.Operation.Source?) -> Payments.ParameterHeader.Icon? {
     ...
     func getHeaderIconForParameters(_ parameters: [PaymentsParameterRepresentable]) -> Payments.ParameterHeader.Icon? {
