...
extension RequestFactory {
    ...
    static func createUpdateFastPaymentContractRequest(
        _ payload: FastPaymentsSettings.RequestFactory.UpdateFastPaymentContractPayload
    ) throws -> URLRequest {
        ...
        return try FastPaymentsSettings.RequestFactory.createUpdateFastPaymentContractRequest(
            url: endpointURL,
            payload: payload
        )
    }
