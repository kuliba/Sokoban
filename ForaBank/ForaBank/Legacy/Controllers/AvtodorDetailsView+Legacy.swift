//
//  AvtodorDetailsFormController + Legacy.swift
//  ForaBank
//
...
struct AvtodorDetailsView: UIViewControllerRepresentable {
    
    let viewModel: AvtodorDetailsViewModel
    
    func makeUIViewController(context: Context) -> AvtodorDetailsFormController {
        
        let vc = AvtodorDetailsFormController.storyboardInstance()!
    ...
    func updateUIViewController(_ uiViewController: AvtodorDetailsFormController, context: Context) {}
}

struct AvtodorDetailsViewModel {
