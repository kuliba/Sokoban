...
public extension Font {
    ...
    static func buttonExtraSmallR12140() -> Font {
        Font.custom("Inter-Regular", size: 12.0)
    }
    ...
    static func printFormBodyMR9120() -> Font {
        Font.custom("Roboto", size: 9.0)
    }
    static func printFormBodySR8100() -> Font {
        Font.custom("Roboto", size: 8.0)
    }
    ...
    static func textBodyXSR11140() -> Font {
        Font.custom("Inter-Regular", size: 11.0)
    }
    ...
    static func textH2M20282() -> Font {
        Font.custom("Inter-Medium", size: 20.0)
    }
