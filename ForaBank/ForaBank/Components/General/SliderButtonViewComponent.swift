...
struct SliderButtonView: View {
    ...
    @ObservedObject var viewModel: SliderButtonView.ViewModel
    ...
    var body: some View {
            ...
            }, settings: TriggerSlider.Settings(sliderViewHeight: 167, sliderViewWidth: 48, sliderViewHPadding: 4, sliderViewVPadding: 4, slideDirection: .right))
...
struct SliderButtonView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        SliderButtonView(viewModel: SliderButtonView.ViewModel(alertPresented: false, sliderState: .normal, foregroundColor: Color.black))
    }
}
...
extension SliderButtonView {
    ...
    struct TriggerSlider<SliderView: View, BackgroundView: View, TextView: View>: View {
        ...
        public init(@ViewBuilder sliderView: () -> SliderView, textView: () -> TextView, backgroundView: () -> BackgroundView, offsetX: Binding<CGFloat>, didSlideToEnd: @escaping () -> Void, settings: Settings = Settings()) {
