...
class BottomSheetHostingViewController: UIHostingController<BottomSheetView<ProductProfileLoanDelayInfoView>> {
    
    private let viewModel: ProductProfileLoanDelayInfoView.ViewModel
    private var bindings = Set<AnyCancellable>()

    init(with viewModel: ProductProfileLoanDelayInfoView.ViewModel) {
