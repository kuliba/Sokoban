//
//  PaymentCountriesResponseData.swift
//  ForaBank
//
...
class PaymentCountriesResponseData: LatestPaymentData {
	...
	internal init(countryCode: String, countryName: String, date: Date, firstName: String?, middleName: String?, paymentDate: String, phoneNumber: String?, puref: String, shortName: String, surName: String?, type: PaymentDataKind) {
