...
extension Payments.Success {
    ...
    init(
        ...
        let params: [PaymentsParameterRepresentable?] = [
            ...
            Payments.ParameterSuccessOptionButtons.buttons(with: .normal, documentStatus: status),
...
extension Payments.Success {
    ...
    init(
        ...
        let params: [PaymentsParameterRepresentable?] = [
            ...
            Payments.ParameterSuccessOptionButtons.buttons(with: mode, documentStatus: documentStatus),
...
extension Payments.Success {
    ...
    static func parameters(
        ...
        // options buttons
        let optionButtonsParam = Payments.ParameterSuccessOptionButtons.buttons(with: mode, documentStatus: documentStatus, operationDetail: operationDetail)
...
extension Payments.ParameterSuccessOptionButtons {
    ...
    static func buttons(with mode: PaymentsSuccessViewModel.Mode, documentStatus: TransferResponseBaseData.DocumentStatus, operationDetail: OperationDetailData? = nil) -> Payments.ParameterSuccessOptionButtons? {
        ...
        case .complete:
            ...
            switch mode {
            case .normal, .meToMe:
                return .init(options: [.template, .document, .details], operationDetail: operationDetail)
                
            case .makePaymentToDeposit, .makePaymentFromDeposit, .closeDeposit, .closeAccount:
                return .init(options: [.document, .details])
                
            case .closeAccountEmpty:
                return .init(options: [.document])
        ...
        case .inProgress:
            ...
            switch mode {
            case .normal, .meToMe:
                return .init(options: [.template, .details], operationDetail: operationDetail)
                
            case .makePaymentToDeposit, .makePaymentFromDeposit, .closeDeposit:
                return .init(options: [.details])
