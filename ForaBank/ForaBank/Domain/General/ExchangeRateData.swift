...
struct ExchangeRateData: Codable, Equatable {
    ...
    init(from decoder: Decoder) throws {
        ...
        self.rateBuyDate = Date.dateUTC(with: rateBuyDateValue)
        ...
        self.rateSellDate = Date.dateUTC(with: rateSellDateValue)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(rateBuyDate.secondsSince1970UTC, forKey: .rateBuyDate)
        try container.encode(rateSell, forKey: .rateSell)
        try container.encode(rateSellDate.secondsSince1970UTC, forKey: .rateSellDate)
