...
extension PaymentsServicesViewModel {
    ...
    static let sample = PaymentsServicesViewModel(header: .init(title: "Налоги и услуги", dismissAction: {}), parameter: .init(category: .taxes, options: []), rootActions: .init(dismiss: {}, spinner: .init(show: {}, hide: {})))
}
