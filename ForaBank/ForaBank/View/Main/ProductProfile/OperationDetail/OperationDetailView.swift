...
extension OperationDetailViewModel {
    ...
    static let sampleComplete: OperationDetailViewModel = {
        ...
        return OperationDetailViewModel(id: "1", header: header, operation: operation, actionButtons: actionButtons, featureButtons: featureButtons, templateButton: .init(model: .emptyMock, operation: nil, operationDetail: OperationDetailData.stub()), isLoading: false, fastUpdateAction: {})
