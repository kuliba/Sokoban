...
extension UIDevice {
    var modelName: String {
        ...
        if var value = ProcessInfo.processInfo.environment["SIMULATOR_MODEL_IDENTIFIER"] {
            ...
            if let simModel = modelMap[String.init(validatingUTF8: value)!] {
                value = simModel.rawValue
