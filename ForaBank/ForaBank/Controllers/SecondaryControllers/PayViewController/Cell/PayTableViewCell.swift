...
class PayTableViewCell: UITableViewCell {
    ...
    override func layoutSubviews() {
        ...
        if titleLabel.text == "Лимиты на операции" || titleLabel.text == "График выплаты % по вкладу" || titleLabel.text == "Закрыть вклад" || titleLabel.text == "Скрыть с главной" || titleLabel.text == "Заказать справку" {
            self.alpha = 0.4
