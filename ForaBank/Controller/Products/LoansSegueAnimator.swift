...
class LoansSegueAnimator: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        if transitionContext.viewController(forKey: .to) is LoansViewController {
            animateSegueToDetailsViewController(using: transitionContext)
        } else if transitionContext.viewController(forKey: .from) is LoansViewController {
            animateUnwindSegue(using: transitionContext)
        } else {
            print("LoansSegueAnimator unprovided transition")
    ...
    func animateSegueToDetailsViewController(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard
            ...
            let toVC = transitionContext.viewController(forKey: .to) as? UIViewController & CustomTransitionDestination
                ...
                print("LoansSegueAnimator animateSegueToDetailsViewController guard return")
                transitionContext.completeTransition(!transitionContext.transitionWasCancelled)
                return
        }
    ...
    func animateUnwindSegue(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard
            ...
            let toVC = transitionContext.viewController(forKey: .to) as? UIViewController & CustomTransitionDestination
                ...
                print("LoansSegueAnimator animateUnwindSegue guard return")
                transitionContext.completeTransition(!transitionContext.transitionWasCancelled)
                return
        }
        let container = transitionContext.containerView
