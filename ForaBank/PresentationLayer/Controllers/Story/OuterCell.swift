...
extension OuterCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setImage(UIImage(named: "\(story.images[indexPath.row].bgImageName)") ?? UIImage(), story.images[indexPath.row].description, story.images[indexPath.row].buttonTitle)
