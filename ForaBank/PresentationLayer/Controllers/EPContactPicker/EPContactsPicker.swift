...
//        tableView.separatorInset = .zero
        self.modalPresentationStyle = .fullScreen //or .overFullScreen for transparency
    ...
    func inititlizeBarButtons() {
        if #available(iOS 13.0, *) {
            let cancelButton = UIBarButtonItem(image: UIImage(systemName: "xmark"), style: .plain, target: self, action: #selector(onTouchCancelButton))
