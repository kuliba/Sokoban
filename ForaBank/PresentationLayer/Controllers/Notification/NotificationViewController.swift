...
class NotificationViewController: UIViewController {
    ...
    //    ]
        let reversedMessages_ = [
            [
                ChatMessage(type: .incoming, time: "23:45", message: "Изменение баланса \("\n") Получен перевод через СБП \n Счет ****3630 \n 16000 RUB \n Отправитель Иван Иванович И. \n Из ПромсвязьБанка \n 29.07.2019 10:43 \n Сообщение Тест 92", isDelivered: true, amount: "")
            ]
        ]
    //    let tableHeaders_ = ["28 ноября", "Сегодня"]
        let reversedHeaders_ = ["Сегодня"] //footers
