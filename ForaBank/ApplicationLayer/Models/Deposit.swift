...
class Deposit {
    ...
    init(depositProductName: String?, isCreditOperationsAvailable: Bool?, balanceCUR: Double? = nil, depositorBrief: String? = nil, currencyCode: String? = nil, ownerAgentBrief: String? = nil, balance: Double? = nil, accountNumber: String? = nil, accountID: String? = nil, customName: String? = nil, accountList: String? = nil, number: String? = nil, blocked: Bool? = nil, startDate: Date? = nil, expirationDate: Date? = nil, availableBalance: Double? = nil, blockedMoney: Double? = nil, updatingDate: Date? = nil, tariff: String? = nil, id: String? = nil, branch: String? = nil, maskedNumber: String? = nil, minimumBalance: Double? = nil, interestRate: Double? = nil, isDebitOperationsAvailable: Bool? = nil,creditMinimumAmount: Double? = nil, initialAmount: Double? = nil, dateEnd: String? = nil, dateStart: String? = nil) {
