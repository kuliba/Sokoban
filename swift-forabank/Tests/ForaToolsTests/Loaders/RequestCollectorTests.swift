...
#warning("add request cancellation")
final class RequestCollector<Request, Response>
where Request: Hashable {
    ...
    typealias Completions = [Request: [Completion]]
    
    typealias PerformRequestsCompletion = ([Request: Response]) -> Void
    typealias PerformRequests = ([Request], @escaping PerformRequestsCompletion) -> Void
}

extension RequestCollector {
