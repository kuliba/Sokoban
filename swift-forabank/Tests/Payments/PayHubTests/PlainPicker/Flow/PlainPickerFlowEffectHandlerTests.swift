//
//  PlainPickerFlowEffectHandlerTests.swift
//
//
...
final class PlainPickerFlowEffectHandlerTests: PlainPickerFlowTests {
    ...
    private typealias SUT = PlainPickerFlowEffectHandler<Element, Navigation>
