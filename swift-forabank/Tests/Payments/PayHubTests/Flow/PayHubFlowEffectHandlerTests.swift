//
//  PayHubFlowEffectHandlerTests.swift
//
//
...
final class PayHubFlowEffectHandlerTests: PayHubFlowTests {
    ...
    private typealias SUT = PayHubFlowEffectHandler<Exchange, Latest, LatestFlow, Templates>
