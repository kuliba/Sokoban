//
//  ResponseMapper+mapGetCollateralLandingRequestResponseTests.swift.swift
//  
//
...
final class ResponseMapper_mapGetCollateralLandingRequestResponseTests: XCTestCase {
    ...
    private typealias Response = [ResponseMapper.GetCollateralLandingData]
    private typealias MappingResult = Swift.Result<
        ResponseMapper.GetCollateralLandingData,
...
private extension ResponseMapper.GetCollateralLandingData {
...
private extension ResponseMapper.GetCollateralLandingData.Product {
...
private extension ResponseMapper.GetCollateralLandingData.Product.Marketing {
...
private extension ResponseMapper.GetCollateralLandingData.Product.Calc {
...
private extension ResponseMapper.GetCollateralLandingData.Product.Calc.Amount {
...
private extension ResponseMapper.GetCollateralLandingData.Product.Icons {
