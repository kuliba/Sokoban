//
//  ResponseMapper_mapPrepareDeleteBankDefaultResponseTests.swift
//  
//
...
final class ResponseMapper_mapPrepareDeleteBankDefaultResponseTests: XCTestCase {
    ...
    private func map(
        ...
        ResponseMapper.mapPrepareDeleteBankDefaultResponse(data, httpURLResponse)
    }
}
