//
//  RequestFactory_createMakeDeleteBankDefaultRequestTests.swift
//
//
...
final class RequestFactory_createMakeDeleteBankDefaultRequestTests: XCTestCase {
    ...
    private func createRequest(
        ...
        try RequestFactory.createMakeDeleteBankDefaultRequest(
            url: url,
            payload: payload
        )
    }
