//
//  ResponseMapper+mapUserVisibilityProductsSettingsResponseTests.swift
//
//
...
final class ResponseMapper_mapUserVisibilityProductsSettingsResponseTests: XCTestCase {
    ...
    func test_map_shouldDeliverNilResponseOnOkHTTPURLResponseStatusCodeWithValidData() throws {
        ...
        let validData = Data(jsonStringWithNilData.utf8)
    ...
    private func map(
        ...
        ResponseMapper.mapUserVisibilityProductsSettingsResponse(data, httpURLResponse)
    }
}
