...
public typealias TransactionOf<DetailID, Details, DocumentStatus, Context> = Transaction<Context, TransactionStatus<TransactionReport<DocumentStatus, OperationInfo<DetailID, Details>>>>
