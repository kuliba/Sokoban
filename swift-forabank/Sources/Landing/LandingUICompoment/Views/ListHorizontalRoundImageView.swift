...
struct ListHorizontalRoundImageView: View {
    ...
    let model: ListHorizontalRoundImageViewModel
    let config: Config
...
extension ListHorizontalRoundImageView {
    ...
    struct ItemView: View {
        ...
        let item: ListHorizontalRoundImageViewModel.Item
        let config: ListHorizontalRoundImageView.Config
