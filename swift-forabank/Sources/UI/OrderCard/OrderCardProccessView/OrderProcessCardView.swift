...
struct OrderProcessCardView<AmountInfo, OTPView, ProductPicker>: View
where AmountInfo: View,
      OTPView: View,
      ProductPicker: View {
    
    let amountToString: AmountToString
    let state: OrderProcessCardState
    ...
    private func condition(
        _ links: OrderProcessCard.Links?
    ) -> some View {
...
extension OrderProcessCardView {
    
    typealias Event = OrderProcessCardEvent
    typealias Config = OrderProcessCardConfig
    typealias Factory = ImageViewFactory
    typealias AmountToString = (Decimal, String) -> String
}

private extension OrderProcessCardState {
...
struct LandingUIView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        NavigationView {
            OrderProcessCardView.placeholder
        }
        .previewDisplayName("Placeholder")
        
        NavigationView {
            OrderProcessCardWrapperView.init(
                viewModel: .init(
...
struct OrderProcessCardWrapperView: View {
...
extension OrderProcessCardWrapperView {
    
    typealias ViewModel = OrderProcessCardViewModel
    typealias Config = OrderProcessCardConfig
}

typealias OrderProcessCardViewModel = RxViewModel<OrderProcessCardState, OrderProcessCardEvent, OrderProcessCardEffect>
