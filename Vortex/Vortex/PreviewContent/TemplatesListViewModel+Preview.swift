...
extension TemplatesListViewModel {
    ...
    static let sampleSelector: OptionSelectorView.ViewModel = .init(
        options: [
    ...
    static let sampleItems: [TemplatesListViewModel.ItemViewModel] = [
        .init(id: 0,
            ...
            .init(id: 1,
                  sortOrder: 1,
                  state: .normal,
                  avatar: .image(.init("Bank Logo Sample")),
                  title: "Маме на Сбер",
    ...
    static let sampleItems2: [TemplatesListViewModel.ItemViewModel] = [
        .init(id: 0, sortOrder: 0,
            ...
            .init(id: 2, sortOrder: 2,
                  state: .normal,
                  avatar: .image(.init("Ban§k Logo Sample")),
                  title: "Жене на Сбер",
                  subTitle: "Перевод по СБП",
    ...
    static let sampleNavBarRegular: TemplatesListViewModel.NavBarState = .regular(.init(
    ...
    static let sampleComplete: TemplatesListViewModel = .init(
        state: .select,
        style: .list,
    ...
    static let sampleTiles: TemplatesListViewModel = .init(
        state: .normal,
        style: .tiles,
        navBarState: TemplatesListViewModel.sampleNavBarRegular,
        categorySelector: TemplatesListViewModel.sampleSelector,
    ...
    static let sampleDeleting: TemplatesListViewModel = .init(
        state: .select,
        style: .tiles,
        navBarState: TemplatesListViewModel.sampleNavBarRegular,
        categorySelector: TemplatesListViewModel.sampleSelector,
...
extension TemplatesListViewModel.EmptyTemplateListViewModel {
    ...
    static let sample: TemplatesListViewModel.EmptyTemplateListViewModel = .init(
        icon: .ic40Star, //Image("Templates Onboarding Icon"),
        title: "Нет шаблонов",
        message: "Вы можете создать шаблон из любой успешной операции в разделе История",
        button: .init(title: "Перейти в историю", action: { })
    )
}
