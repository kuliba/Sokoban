...
extension Payments {
    ...
    struct Success {
        ...
        static let antifraudSubtitle = "Ожидайте звонка call-центра банка для подтверждения операции или позвоните по телефону +7 800 100 98 89. В случае если в течение 2-х дней мы не сможем получить от Вас дополнительное подтверждение операции, она будет отменена."
    }
}
