//
//  Services+getProductListByTypeV7.swift
//  Vortex
//
...
extension Services {
    ...
    typealias GetProductListByTypeV7Completion = (GetProductsResponse?) -> Void
    typealias GetProductListByTypeV7 = (ProductType, @escaping GetProductListByTypeV7Completion) -> Void
    
    static func getProductListByTypeV7(
        _ httpClient: HTTPClient,
        _ timeout: TimeInterval = 120.0,
        logger: LoggerAgentProtocol
    ) -> GetProductListByTypeV7 {
        ...
        let loggingRemoteService = LoggingRemoteServiceDecorator(
            createRequest: RequestFactory.createGetProductListByTypeV7Request,
            performRequest: httpClient.performRequest,
            mapResponse: RemoteServices.ResponseMapper.mapGetProductListByTypeV7Response,
            log: infoNetworkLog
        ).remoteService
    ...
    static func mapProductsResponse(
        _ productsResponse: RemoteServices.ResponseMapper.GetProductListByTypeV7Response
    ) -> GetProductsResponse {
        
        .init(
            serial: productsResponse.serial ?? "",
            productList: productsResponse.list.map {
...
private extension ProductCardData {
    ...
    convenience init(
        commonData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.CommonProperties,
        cardData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.Card
    ) {
...
private extension ProductLoanData {
    ...
    convenience init(
        commonData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.CommonProperties,
        loanData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.Loan
    ) {
...
private extension ProductDepositData {
    ...
    convenience init(
        commonData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.CommonProperties,
        depositData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.Deposit
    ) {
...
private extension ProductAccountData {
    ...
    convenience init(
        commonData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.CommonProperties,
        accountData: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.Account
    ) {
        ...
        self.init(
            ...
            largeDesignMd5Hash: commonData.largeDesignMd5Hash,
            xlDesignMd5Hash: commonData.xlDesignMd5Hash,
            isSavingAccount: accountData.isSavingAccount,
...
private extension ProductType {
    ...
    init(_ productType: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.ProductType) {
...
private extension ProductData.Status {
    ...
    init(_ status: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.Status) {
...
private extension ProductCardData.LoanBaseParamInfoData {
    ...
    init(loan: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.LoanBaseParam) {
...
private extension ProductData.StatusPC {
    ...
    init(_ statusPC: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.StatusPC) {
...
private extension ProductCardData.StatusCard {
    ...
    init(_ statusCard: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.StatusCard) {
...
private extension ProductCardData.CardType {
    ...
    init(_ cardType: RemoteServices.ResponseMapper.GetProductListByTypeV7Data.CardType) {
