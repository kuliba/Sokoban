...
extension PaymentsSelectCountryView.ViewModel.ListViewModel {
    ...
    static let itemsViewModelSample = PaymentsSelectCountryView.ViewModel.ListViewModel(items: [.init(id: "", icon: .icon(Image.ic64Color), name: "ИННОВАЦИИ БИЗНЕСА", subtitle: "0445283290", action: {_ in })], filteredItems: [])
}
