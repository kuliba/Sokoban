...
extension ProductProfileHistoryView.ViewModel.HistoryListViewModel.DayGroupViewModel {
    ...
    static let creditOperation = Operation(statement: .init(id: 1, date: Date(), imageId: ""), title: "Оплата банка", image: Image.init("vortexContactImage"), subtitle: "Услуги банка", amount: .init(value: "-100 Р", color: .black), amountStatusImage: Image("MigAvatar"))
}
