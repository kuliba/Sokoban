...
extension OfferProductView {
    ...
    class ViewModel: Identifiable, ObservableObject {
        ...
        init(
            ...
            self.orderButton = OrderButton(url: .init(string: "https://www.\(Config.domen)")!)
            ...
            bind()
            self.infoButton = createInfoButton(with: .init(string: "https://www.\(Config.domen)"))
        }
