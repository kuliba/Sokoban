...
extension Model {
    ...
    func paymentsProcess(operation: Payments.Operation) async throws -> Payments.ProcessResult {
        ...
        try await Self.paymentsProcess(
            ...
            resetVisible: paymentsProcessOperationResetVisible(operation:),
            ...
            dependenceReducer: paymentsProcessDependencyReducer(operation:parameterId:parameters:))
    }
    ...
    static func paymentsProcess(operation: Payments.Operation,
                         ...
                         resetVisible: (Payments.Operation) async throws -> [Payments.Parameter.ID]?,
                         ...
                         sourceReducer: (Payments.Service, Payments.Operation.Source, Payments.Parameter.ID) -> Payments.Parameter.Value?,
                                dependenceReducer: (Payments.Operation, Payments.Parameter.ID, [PaymentsParameterRepresentable]) -> PaymentsParameterRepresentable?) async throws -> Payments.ProcessResult {
        ...
        repeat {
            ...
            case let .backProcess(parameters: parameters, stepIndex: stepIndex, stage: stage):
                ...
                case .local:
                    ...
                    if let resetedVisible = try await resetVisible(operation) {
    
                        operation = operation.reseted(visible: resetedVisible)
                    }
