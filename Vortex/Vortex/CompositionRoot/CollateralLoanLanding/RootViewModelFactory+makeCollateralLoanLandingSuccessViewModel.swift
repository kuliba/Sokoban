...
extension RootViewModelFactory {
    ...
    @inlinable
    func makeCollateralLoanLandingSuccessViewModel() -> CollateralLoanLandingFactory.MakeCollateralLoanLandingSuccessViewModel {
        
        return { .init(paymentSuccess: $0.success, self.model) }
    }
    
    func makeCollateralLoanLandingFactory() -> CollateralLoanLandingFactory {
        
        .init(makeCollateralLoanLandingSuccessViewModel: makeCollateralLoanLandingSuccessViewModel())
    }
}
