//
//  RootViewModelFactory+startC2GPayment.swift
//  Vortex
//
...
extension RootViewModelFactory {
    ...
    typealias C2GPaymentResult = Result<C2GPaymentDomain.Binder, BackendFailure>

    @inlinable
    func startC2GPayment(
        uin: String,
        completion: @escaping (C2GPaymentResult) -> Void
    ) {
