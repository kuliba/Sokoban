...
@available(*, deprecated, message: "use `AnywayTransactionViewModelComposer`")
final class __AnywayTransactionViewModelComposer {
...
extension __AnywayTransactionViewModelComposer {
