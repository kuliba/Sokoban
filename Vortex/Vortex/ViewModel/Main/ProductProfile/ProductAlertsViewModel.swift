...
extension ProductAlertsViewModel {
    ...
    static let `default`: Self = .init(
        ...
        serviceOnlyIndividualCard: "Данная операция не доступна для сотрудника/держателя корпоративной карты. Обратитесь к своему работодателю. Пополнение и перевод доступны через «Инновации Бизнес»."
    )
}
