...
extension PlacesDetailViewModel {
    ...
    static let sample = PlacesDetailViewModel(id: UUID().uuidString, icon: .ic48PinOffice, name: "Рублевский (офис)", address: "г. Москва, Рублевское ш., дом 62, ТЦ «ЕвроПарк»", metro: .init(stations: [.init(id: 1, name: "Крылатское", color: Color(hex: "#3377B9")), .init(id: 2, name: "Крылатское", color: Color(hex: "#3377B9")), .init(id: 3, name: "Крылатское", color: Color(hex: "#3377B9"))]), distance: "128 M", routeButton: .init(action: {}), schedule: "Ежедневно: 10:00 - 21:45", phoneNumber: "(495) 204 4612", email: "rumyantsevo@innovation.ru", services: .init(services: [.init(id: 1, name: "Без выходных"), .init(id: 2, name: "Вклады"), .init(id: 3, name: "Потреб. кредиты"), .init(id: 4, name: "Ипотека"), .init(id: 5, name: "Выдача наличных"), .init(id: 6, name: "Прием наличных"), .init(id: 7, name: "Денежные переводы"), .init(id: 8, name: "Оплата услуг"), .init(id: 9, name: "Аккредитивы"), .init(id: 10, name: "регистрация в ЕБС"), .init(id: 11, name: "Обслуживание юридических лиц")]))
}
