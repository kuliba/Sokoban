//
//  LoggingRemoteNanoServiceComposerAsFactoryWithPayloadTests.swift
//  ForaBankTests
//
...
final class LoggingRemoteNanoServiceComposerAsFactoryWithPayloadTests: LoggingRemoteNanoServiceComposerAsFactoryTests {
    ...
    func test_composed_shouldDeliverMappedFailureOnHTTPClientFailure() {
        ...
        expect(sut, with: makePayload(), delivers: .failure(anyError())) {
    ...
    func test_composedVoid_shouldDeliverMappedFailureOnHTTPClientFailure() {
        ...
        expect(sut, with: (), delivers: .failure(anyError())) {
