//
//  ResponseMapper+mapGetProductListByTypeV7Response.swift
//
//
...
public extension ResponseMapper {
    ...
    static func mapGetProductListByTypeV7Response(
        _ data: Data,
        _ httpURLResponse: HTTPURLResponse
    ) -> MappingResult<GetProductListByTypeV7Response> {
        
        map(data, httpURLResponse, mapOrThrow: ResponseMapper.GetProductListByTypeV7Response.init(data:))
    }
}

private extension ResponseMapper.GetProductListByTypeV7Response {
...
private extension ResponseMapper.GetProductListByTypeV7Data.ProductType {
...
private extension ResponseMapper.GetProductListByTypeV7Data.Status {
...
private extension ResponseMapper.GetProductListByTypeV7Data.LoanBaseParam {
...
private extension ResponseMapper.GetProductListByTypeV7Data.StatusPC {
...
private extension ResponseMapper.GetProductListByTypeV7Data.StatusCard {
...
private extension ResponseMapper.GetProductListByTypeV7Data.CardType {
...
private extension ResponseMapper.GetProductListByTypeV7Data.ProductState {
...
private extension ResponseMapper.GetProductListByTypeV7Data {
    ...
    init(_ data: ResponseMapper._Data.ProductDTO) {
...
private extension ResponseMapper.GetProductListByTypeV7Data.CommonProperties {
...
private extension ResponseMapper.GetProductListByTypeV7Data.UniqueProperties {
    
    init(_ data: ResponseMapper._Data.ProductSettingsDTO) {
...
private extension ResponseMapper.GetProductListByTypeV7Data.Card {
...
private extension ResponseMapper.GetProductListByTypeV7Data.Loan {
...
private extension ResponseMapper.GetProductListByTypeV7Data.Deposit {
...
private extension ResponseMapper.GetProductListByTypeV7Data.Account {
    ...
    init(_ data: ResponseMapper.AccountSettingsDTO) {
        ...
        self.init(
            ...
            isSavingAccount: data.isSavingAccount ?? false,
            interestRate: data.interestRate ?? ""
        )
    }
}
