//
//  PaymentsTransfersPersonalToolbarContentView.swift
//
//
...
public struct PaymentsTransfersPersonalToolbarContentView<ProfileLabel, QRLabel>: View
...
public extension PaymentsTransfersPersonalToolbarContentView {
...
struct PaymentsTransfersToolbarContentView_Previews: PreviewProvider {
    ...
    private static func preview(
        _ state: PaymentsTransfersPersonalToolbarContentView.State
    ) -> some View {
...
private extension PaymentsTransfersPersonalToolbarContentView {
