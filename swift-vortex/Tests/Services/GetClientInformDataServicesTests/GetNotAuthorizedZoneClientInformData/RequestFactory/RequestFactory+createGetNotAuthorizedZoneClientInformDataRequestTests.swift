//
//  RequestFactory+createGetAuthorizedZoneClientInformDataRequestTests.swift
//  ForaBank
//
...
final class RequestFactory_createGetNotAuthorizedZoneClientInformDataRequestTests: XCTestCase {
    ...
    private func createRequest(
        ...
        try RequestFactory.createGetNotAuthorizedZoneClientInformData(url: url)
    }
}
