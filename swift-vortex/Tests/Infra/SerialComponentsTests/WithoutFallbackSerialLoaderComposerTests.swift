...
final class WithoutFallbackSerialLoaderComposerTests: XCTestCase {
    ...
    func test_load_shouldNotCallPersistentAndRemoteOnEmptyEphemeral() {
        ...
        let (sut, ephemeral, persistent, remoteLoad) = makeSUT()
        let load = sut.composeWithoutFallback().load
    ...
    func test_load_shouldDeliverFailureOnEphemeralAndPersistentFailure() {
    ...
    func test_reload_shouldDeliverNilOnRemoteFailureWithNilSerial() {
        ...
        sut.composeWithoutFallback().reload {
