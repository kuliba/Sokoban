//
//  NonReloadableReducerTests.swift
//
//
...
final class NonReloadableReducerTests: LoadTests {
    ...
    func test_load_shouldNotChangeState_onCompletedState() {
    ...
    func test_load_shouldNotDeliverEffect_onCompletedState() {
        
        assert(.completed(makeSuccess()), event: .load, delivers: nil)
    }
