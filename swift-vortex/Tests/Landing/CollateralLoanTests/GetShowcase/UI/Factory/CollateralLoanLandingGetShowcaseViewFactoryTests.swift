//
//  CollateralLoanLandingGetShowcaseViewFactoryTests.swift
//
//
...
final class CollateralLoanLandingGetShowcaseViewFactoryTests: XCTestCase {
    ...
    private typealias SUT = CollateralLoanLandingGetShowcaseViewFactory
    private typealias Product = CollateralLoanLandingGetShowcaseData.Product
