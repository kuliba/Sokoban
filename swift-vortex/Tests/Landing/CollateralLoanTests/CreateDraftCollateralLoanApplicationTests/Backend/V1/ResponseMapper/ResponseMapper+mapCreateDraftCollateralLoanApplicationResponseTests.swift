//
//  ResponseMapper+mapCreateDraftCollateralLoanApplicationResponseTests.swift
//  
//
...
final class ResponseMapper_mapCreateDraftCollateralLoanApplicationResponseTests: XCTestCase {
    ...
    func test_map_shouldDeliverInvalidFailureOnEmptyPayload() {
    ...
    private func map(
        ...
        ResponseMapper.mapCreateDraftCollateralLoanApplicationResponse(data, httpURLResponse)
    }
}
