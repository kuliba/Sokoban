...
private class ItemView: UIView {
    ...
    static var normalNextSizeRatio: CGFloat = 0.8
    static var mediumSizeRatio: CGFloat = 0.7
    static var smallSizeRatio: CGFloat = 0.6
    ...
    private func updateDotSize(state: State) {
        ...
        case .None:
            _size = CGSize.zero
        case .NormalNext:
            _size = CGSize(width: dotSize * ItemView.normalNextSizeRatio, height: dotSize * ItemView.normalNextSizeRatio)
        }
